# SLURM job entry: Poisson outcome, one (structure, lam_g, lam_t) combination.
# usage: Rscript cluster/run_one_job_poisson.R <structure> <lam_g> <lam_t>
...
source(here::here("R", "poisson", "mcem_cgd.R"))
source(here::here("R", "poisson", "generate_data.R"))
