...
# Load data
bin <- readRDS("plots/res/binary/(N,T,p)-(100,10,10)-Block.rds")
poi <- readRDS("plots/res/poisson/(N,T,p)-(100,10,10)-Block.rds")
mul <- readRDS("plots/res/multinomial/(N,T,p)-(100,10,10)-Block.rds")
